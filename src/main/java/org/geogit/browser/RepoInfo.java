...
public class RepoInfo {
	...
	public static enum EntryType{
		FEATURE,FEATURE_ID, FEATURE_TYPE_NAME, FEATURE_TYPE, REF_COMMIT,REF_TREE,REF_TAG,REF_REMOTE, REF_NAMESPACE, REF_FEATURE_TYPE, REF_FEATURE;
	}
